      ...
      <div class="row section-header">
        <div class="col-12 mb1">
          <div>
            <h1>:::title:::</h1>
            <ul class="breadcrumb">
            <a href=":::assetfullpath.shortcutid-756604:::">About Us</a> > <a href=":::assetfullpath.shortcutid-754267:::">Document Library</a>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row title-list">
              ...
              <xsl:if test="PostKind = '1' or PostKind = '3'">
                <p class="SKPostsListItemDate">
                    <xsl:choose>
                        <xsl:when test="RepeatPattern = '0'">
                          <strong>Published: <xsl:value-of select="date:format-date(date:dateTime(StartDate), 'dd MMMMM yyyy')"/></strong>
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <!-- <div class="relative-bottom">
                 <xsl:if test="(contains(site-section, 'NIHR'))">
                 ...
                 <xsl:if test="(contains(site-section, 'Researchers'))">
                  ...
                  <xsl:if test="(contains(site-section, 'Community'))">
                  ...
                  <xsl:if test="(contains(site-section, 'Partners'))">
                  ...
                  <xsl:if test="(contains(site-section, 'Patients'))">
