...
(function ($) {
    ...
    var pluginName = 'glossarizer',
        defaults = {
            sourceURL: '',
            /* URL of the JSON file with format {"term": "", "description": ""} */
            replaceTag: 'abbr',
            /* Matching words will be wrapped with abbr tags by default */
            lookupTagName: 'p, ul, ol, a, div',
    ...
    function Glossarizer(el, options) {
        ...
        $.getJSON(this.options.sourceURL).then(function (data) {
            ...
            base.glossary = data.Posts;
            if (!base.glossary.length || base.glossary.length == 0) return;
            /**
             * Get all terms
             */
            for (var i = 0; i < base.glossary.length; i++) {
                var terms = base.glossary[i].Name.split(',');
    ...
    Glossarizer.prototype = {
        ...
        getDescription: function (Name) {
            ...
            var regex = new RegExp('(\,|\s*)' + this.clean(Name) + '\\s*|\\,$', 'i');
            ...
            for (var i = 0; i < this.glossary.length; i++) {
                if (this.glossary[i].Name.match(regex)) {
